...
modules = [Bin("demo-noclip", ["snowmew-core", "snowmew-render-mux", "snowmew-loader"]),
           Bin("rust-gears", ["snowmew-core", "snowmew-render-mux", "snowmew-loader"]),
           Bin("demo-cubes", ["snowmew-core", "snowmew-render-mux"]),
           Lib("snowmew-core", ["cgmath", "cow", "gl", "OpenCL", "glfw", "oculus-vr", "gl_cl"]),
           Lib("snowmew-render", ["snowmew-core", "gl", "OpenCL", "gl_cl", "render-data"]),
           #Lib("snowmew-core", ["cgmath", "cow", "gl", "OpenCL", "glfw", "oculus-vr", "gl_cl", "gfx"]),
           #Lib("snowmew-render", ["snowmew-core", "gl", "OpenCL", "gl_cl", "render-data", "gfx"]),
           #Lib("snowmew-render-gfx", ["snowmew-core", "gfx", "render-data"]),
           #Lib("snowmew-render-mux", ["snowmew-render", "snowmew-render-gfx", "snowmew-core", "render-data"]),
           Lib("snowmew-render-mux", ["snowmew-render", "snowmew-core", "render-data"]),
           Lib("render-data", ["snowmew-position", "snowmew-graphics"]),
           Lib("snowmew-loader", ["snowmew-core", "snowmew-graphics", "stb-image"]),
           Lib("snowmew-physics", ["snowmew-core", "collision", "snowmew-position", "cow"]),
           Lib("snowmew-position", ["snowmew-core", "cgmath", "OpenCL", "cow"]),
           Lib("snowmew-graphics", ["snowmew-core", "cgmath", "cow", "collision", "stb-image"]),
